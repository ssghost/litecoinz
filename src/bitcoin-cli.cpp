...
std::string HelpMessageCli()
{
    ...
    strUsage += HelpMessageOpt("-usewallet=<walletname>", _("Send RPC for non-default wallet on RPC server (argument is wallet filename in litecoinzd directory, required if litecoinzd/-Qt runs with multiple wallets)"));
