...
UniValue getlocalsolps(const JSONRPCRequest& request)
{
...
UniValue getnetworksolps(const JSONRPCRequest& request)
{
...
UniValue getmininginfo(const JSONRPCRequest& request)
{
    ...
    obj.push_back(Pair("localsolps"  ,     getlocalsolps(request)));
    obj.push_back(Pair("networksolps",     getnetworksolps(request)));
    obj.push_back(Pair("networkhashps",    getnetworksolps(request)));
