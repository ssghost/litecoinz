...
{
    {
        ...
        Note note3(addr.a_pk, 84000000000000001, random_uint256(), random_uint256());
        increment_note_witnesses(note3.cm(), witnesses, tree);
        Note note4(addr.a_pk, 76000000000000000, random_uint256(), random_uint256());
        increment_note_witnesses(note4.cm(), witnesses, tree);
        Note note5(addr.a_pk, 76000000000000000, random_uint256(), random_uint256());
        ...
        {
            JSOutput(addr, 84000000000000001),
            JSOutput()
        },
        0,
        0,
        ...
        {
            JSOutput(addr, 76000000000000000),
            JSOutput(addr, 76000000000000000)
        },
        0,
        0,
