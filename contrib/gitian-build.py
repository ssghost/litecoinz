...
def setup():
    ...
    if not os.path.isdir('litecoinz'):
        subprocess.check_call(['git', 'clone', 'https://github.com/litecoinz-project/litecoinz.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/litecoinz-project/litecoinz', help='Specify the URL of the repository. Default is %(default)s')
