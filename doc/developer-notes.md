...
- [Development guidelines](#development-guidelines)
    - [General LitecoinZ Core](#general-litecoinz-project)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
([`valgrind.supp`](https://github.com/litecoinz-project/litecoinz/blob/master/contrib/valgrind.supp))
...
would be to revert the upstream fix before applying the updates to LitecoinZ's
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:litecoinz-project/litecoinz.git
