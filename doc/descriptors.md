...
Since LitecoinZ Core v2.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `ltz1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on LitecoinZ's OP_CHECKMULTISIG opcode. To support these, we introduce the
