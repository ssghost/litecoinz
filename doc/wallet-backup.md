...
For all methods, you will need to include an export directory setting in your config file (`litecoinz.conf` located in the data directory which is `~/.zcash/` unless it's been overridden with `datadir=` setting):
